...
DEFINE_CMD_CLASS(cSaveRefListCmd)

int cSaveRefListCmd::SyntaxCheck (cParser *par_Parser)
{
    UNUSED(par_Parser);
    return 0;
}

int cSaveRefListCmd::Execute (cParser *par_Parser, cExecutor *par_Executor)
{
    UNUSED(par_Executor);
    int Pid;
...
int cSaveRefListCmd::Wait (cParser *par_Parser, cExecutor *par_Executor, int Cycles)
{
    UNUSED(par_Parser);
    UNUSED(par_Executor);
    UNUSED(Cycles);
...
static cSaveRefListCmd SaveRefListCmd ("SAVE_REF_LIST",                        
                                       2, 
                                       2,  
                                       nullptr,
                                       FALSE, 
