...
DEFINE_CMD_CLASS(cLoadCanVariantCmd)


int cLoadCanVariantCmd::SyntaxCheck (cParser *par_Parser)
{
    UNUSED(par_Parser);
    return 0;
}

int cLoadCanVariantCmd::Execute (cParser *par_Parser, cExecutor *par_Executor)
{
    UNUSED(par_Executor);
    double erg;
    int Channel;
...
int cLoadCanVariantCmd::Wait (cParser *par_Parser, cExecutor *par_Executor, int Cycles)
{
    UNUSED(par_Parser);
    UNUSED(par_Executor);
    UNUSED(Cycles);
...
static cLoadCanVariantCmd LoadCanVariantCmd ("LOAD_CAN_VARIANT",                        
                                             2, 
                                             2,  
                                             nullptr,
                                             FALSE, 
