...
class AddNewProcessSchedulerBarrier : public Dialog
{
    Q_OBJECT

public:
    explicit AddNewProcessSchedulerBarrier(QString WhatToAdd, bool WaitIfAloneVisable = false, QWidget *parent = nullptr);
