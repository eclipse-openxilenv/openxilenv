...
#ifndef UserDrawPoint_H
#define UserDrawPoint_H

#include <QString>
#include <QList>
#include "UserDrawElement.h"

class UserDrawPoint : public UserDrawElement {
public:
    UserDrawPoint(int par_Pos, QString &par_ParameterString, UserDrawElement *par_Parent = nullptr);
    ~UserDrawPoint();
