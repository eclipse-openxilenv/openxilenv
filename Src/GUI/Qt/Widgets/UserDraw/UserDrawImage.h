...
#ifndef USERDRAWIMAGE_H
#define USERDRAWIMAGE_H

#include <QString>
#include <QList>
#include "UserDrawElement.h"

class UserDrawImage : public UserDrawElement {
public:
    UserDrawImage(int par_Pos, QString &par_ParameterString, UserDrawElement *par_Parent = nullptr);
    ~UserDrawImage();
