...
#ifndef USERDRAWPOLYGON_H
#define USERDRAWPOLYGON_H

#include <QString>
#include <QList>
#include "UserDrawElement.h"

class UserDrawPolygon : public UserDrawElement {
public:
    UserDrawPolygon(int par_Pos, QString &par_ParameterString, UserDrawElement *par_Parent = nullptr);
    ~UserDrawPolygon();
