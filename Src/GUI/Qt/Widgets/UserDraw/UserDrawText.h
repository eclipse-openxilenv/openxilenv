...
#ifndef UserDrawText_H
#define UserDrawText_H

#include <QString>
#include <QList>
#include "UserDrawElement.h"

class UserDrawText : public UserDrawElement {
public:
    UserDrawText(int par_Pos, QString &par_ParameterString, UserDrawElement *par_Parent = nullptr);
    ~UserDrawText();
