...
#ifndef USERDRAWTYPE_H
#define USERDRAWTYPE_H


#include "MdiWindowType.h"

class UserDrawType : public MdiWindowType {
    Q_OBJECT
    Q_INTERFACES(InterfaceWidgetPlugin)
public:
    explicit UserDrawType(QObject *parent = nullptr);
    ~UserDrawType() Q_DECL_OVERRIDE;
