...
#ifndef USERDRAWROOT_H
#define USERDRAWROOT_H
...
class UserDrawRoot : public UserDrawElement {
public:
    UserDrawRoot(int par_Pos, QString &par_ParameterString, UserDrawElement *par_Parent = nullptr);
    ~UserDrawRoot();
