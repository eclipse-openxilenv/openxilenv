...
#ifndef BARGRAPHTYPE_H
#define BARGRAPHTYPE_H

#include "MdiWindowType.h"

class BargraphType : public MdiWindowType {
    Q_OBJECT
    Q_INTERFACES(InterfaceWidgetPlugin)
public:
    explicit BargraphType(QObject *parent = nullptr);
    ~BargraphType() Q_DECL_OVERRIDE;
