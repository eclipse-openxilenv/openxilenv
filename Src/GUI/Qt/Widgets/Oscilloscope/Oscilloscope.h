...
class OscilloscopeType : public MdiWindowType {
    Q_OBJECT
    Q_INTERFACES(InterfaceWidgetPlugin)
public:
    explicit OscilloscopeType(QObject *parent = nullptr);
    ~OscilloscopeType() Q_DECL_OVERRIDE;
    ...
    QList<OscilloscopeWidget*> GetAllOpenOscilloscopeWidgets ();
