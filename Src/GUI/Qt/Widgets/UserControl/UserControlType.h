...
#ifndef USERCONTROLTYPE_H
#define USERCONTROLTYPE_H

#include "MdiWindowType.h"

class UserControlType : public MdiWindowType {
    Q_OBJECT
    Q_INTERFACES(InterfaceWidgetPlugin)
public:
    explicit UserControlType(QObject *parent = nullptr);
    ~UserControlType() Q_DECL_OVERRIDE;
