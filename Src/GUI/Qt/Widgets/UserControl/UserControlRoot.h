...
#ifndef USERCONTROLROOT_H
#define USERCONTROLROOT_H
...
class UserControlRoot : public UserControlElement {
    Q_OBJECT
public:
    UserControlRoot(int par_Pos, QString &par_ParameterString, UserControlElement *par_Parent = nullptr);
    ~UserControlRoot();
    ...
    void SetWidget(UserControlWidget *par_Widget);
private:
    QList<UserControlElement*> m_Childs;
    QGridLayout *m_Layout;
    UserControlWidget *m_RootWidget;
};


#endif // USERCONTROLROOT_H
