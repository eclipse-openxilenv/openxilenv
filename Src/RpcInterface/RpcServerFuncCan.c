...
static int RPCFunc_SetCanChannelStartupState(RPC_CONNECTION *par_Connection, RPC_API_BASE_MESSAGE *par_DataIn, RPC_API_BASE_MESSAGE_ACK *par_DataOut)
{
    UNUSED(par_Connection);
    //UNUSED(par_DataIn);
...
int AddCanFunctionToTable(void)
{
    ...
    AddFunctionToRemoteAPIFunctionTable2(RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_CMD, 1, RPCFunc_SetCanChannelStartupState, sizeof(RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE), sizeof(RPC_API_SET_CAN_CHANNEL_COUNT_MESSAGE), STRINGIZE(RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_MEMBERS), STRINGIZE(RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_ACK_MEMBERS));
    // CAN FD
