...
#define RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_CMD         (CAN_CMD_OFFSET+25)
typedef struct {
#define  RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_MEMBERS \
    RPC_API_BASE_MESSAGE Header;\
        int32_t Channel;\
        int32_t StartupState;
    RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_MEMBERS
}  RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE;

typedef struct {
#define  RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_ACK_MEMBERS \
    RPC_API_BASE_MESSAGE_ACK Header;
    RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_ACK_MEMBERS
}  RPC_API_SET_CAN_CHANNEL_STARTUP_STATE_MESSAGE_ACK;
