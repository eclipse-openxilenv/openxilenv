...
#define RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_CMD           (SCHED_CMD_OFFSET+17)
typedef struct {
#define RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_MESSAGE_MEMBERS \
    RPC_API_BASE_MESSAGE Header;\
        int32_t Cycles;\
        int32_t OffsetConditions;\
        char Data[1];  // > 1Byte!
    RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_MESSAGE_MEMBERS
} RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_MESSAGE;

typedef struct {
#define RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_MESSAGE_ACK_MEMBERS \
    RPC_API_BASE_MESSAGE_ACK Header;
    RPC_API_DO_NEXT_CYCLES_AND_WAIT_MESSAGE_ACK_MEMBERS
} RPC_API_DO_NEXT_CONDITIONS_CYCLES_AND_WAIT_MESSAGE_ACK;
