...
class CAN_FIFO_ELEM(ct.Structure):
    _fields_ = [('id', ct.c_uint32), ('data', ct.c_uint8 * 8), ('size', ct.c_uint8), ('ext', ct.c_uint8), ('flag',
                                                                                                           ct.c_uint8), ('channel', ct.c_uint8), ('node', ct.c_uint8), ('fill',  ct.c_uint8 * 7), ('timestamp', ct.c_uint64)]

    def __repr__(self):
        s = 'CAN_FIFO_ELEM(id={}, size={}, ext={}, flag={}, channel={}, node={}, timestamp={},\n  data='.format(
            self.id, self.size, self.ext, self.flag, self.channel, self.node, self.timestamp)
        c = 0
...
class CAN_FD_FIFO_ELEM(ct.Structure):
    _fields_ = [('id', ct.c_uint32), ('data', ct.c_uint8 * 64), ('size', ct.c_uint8), ('ext', ct.c_uint8), ('flag',
                                                                                                            ct.c_uint8), ('channel', ct.c_uint8), ('node', ct.c_uint8), ('fill',  ct.c_uint8 * 7), ('timestamp', ct.c_uint64)]
...
class BB_VARI(ct.Union):
    _fields_ = [('b', ct.c_int8), ('ub', ct.c_uint8), ('w', ct.c_int16), ('uw', ct.c_uint16), ('dw', ct.c_int32),
                ('udw', ct.c_uint32), ('qw', ct.c_int64), ('uqw', ct.c_uint64), ('f', ct.c_float), ('d', ct.c_double)]
...
# Scheduler
        ...
        self.__Dll.XilEnv_StartProcessEx.argtypes = [ct.c_char_p, ct.c_int,  ct.c_int, ct.c_short, ct.c_int, ct.c_char_p, ct.c_char_p,
                                                     ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_char_p, ct.c_int, ct.c_char_p, ct.c_int, ct.c_int]

        self.__Dll.XilEnv_StartProcessEx2.restype = ct.c_int
        self.__Dll.XilEnv_StartProcessEx2.argtypes = [ct.c_char_p, ct.c_int,  ct.c_int, ct.c_short, ct.c_int, ct.c_char_p, ct.c_char_p, ct.c_uint,
                                                      ct.c_char_p, ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_char_p, ct.c_int, ct.c_char_p, ct.c_int, ct.c_int]
...
# Blackboard
        ...
        self.__Dll.XilEnv_WriteFrameWaitReadFrame.argtypes = [ct.POINTER(ct.c_int), ct.POINTER(
            ct.c_double), ct.c_int, ct.POINTER(ct.c_int), ct.POINTER(ct.c_double), ct.c_int]

        self.__Dll.XilEnv_ReferenceSymbol.restype = ct.c_int
        self.__Dll.XilEnv_ReferenceSymbol.argtypes = [ct.c_char_p, ct.c_char_p, ct.c_char_p, ct.c_char_p,
                                                      ct.c_int, ct.c_char_p, ct.c_double, ct.c_double, ct.c_int, ct.c_int, ct.c_int, ct.c_int]
...
# XCP
        ...
        self.__Dll.XilEnv_TransmitCAN.argtypes = [ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.c_ubyte,
                                                  ct.c_ubyte, ct.c_ubyte, ct.c_ubyte, ct.c_ubyte, ct.c_ubyte, ct.c_ubyte, ct.c_ubyte]
...
# CAN Recorder
        ...
        self.__Dll.XilEnv_StartCANRecorder.argtypes = [ct.c_char_p, ct.c_char_p, ct.c_int,
                                                       ct.c_int, ct.c_int, ct.c_int, ct.c_int, ct.POINTER(CAN_ACCEPTANCE_WINDOWS)]
...
# A2LLink
        ...
        self.__Dll.XilEnv_GetNextSymbolFromLink.argtypes = [
            ct.c_int, ct.c_int, ct.c_int, ct.c_char_p, ct.POINTER(ct.c_ubyte), ct.c_int]
...
# Array of values
        ...
        self.__Dll.XilEnv_GetLinkArrayValueDataString.argtypes = [
            ct.c_void_p, ct.c_int, ct.c_int, ct.POINTER(ct.c_char), ct.c_int]
...
# Calibration
    ...
    def GetSymbolRawEx(self, Symbol, Process):
        if (self.__SuccessfulConnected == 1):
            Data = (BB_VARI)()
            DataType = self.__Dll.XilEnv_GetSymbolRaw(self.c_str(Symbol), self.c_str(
                Process), 0x1000, Data)  # flags = 0x1000 -> no error message
    ...
    def SetSymbolRawEx(self, Symbol, Process, Value):
        if (self.__SuccessfulConnected == 1):
            ...
            if (DataType == 0):  # int8_t
                ...
                return -1
            # flags = 0x1000 -> no error message
            return self.__Dll.XilEnv_SetSymbolRaw(self.c_str(Symbol), self.c_str(Process), 0x1000, DataType, Data)
        else:
            return -1
